...
uv tool install git+https://github.com/vishwassharma/neev-voice.git@v0.11.0
...
uv tool install git+https://github.com/vishwassharma/neev-voice.git@v0.11.0 --force
```
...
uv add git+https://github.com/vishwassharma/neev-voice.git@v0.11.0
```
